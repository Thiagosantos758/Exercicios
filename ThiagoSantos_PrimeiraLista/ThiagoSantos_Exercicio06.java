...
public class ThiagoSantos_Exercicio06 {
    public static void main(String [] args){
        Scanner input = new Scanner (System.in); //Faz com que a vaiável input receba informações digitadas pelo usuário
        double pi = 3.1415; //Atribui um valor constante de 3,1415 para a variável pi
        System.out.println("Digite o valor do raio do círculo: ");
        double raio = input.nextDouble();
        double per = raio*(pi*2); //calcula o perímetro e salva o resultado na variável "per"
